...
export default {
    ...
    category: 'game',
    usage: '.wordgame <create|join|start|stop|top|reload>',
    tips: [
        '.wordgame create — crée une partie, puis .wordgame start seul(e) pour jouer en solo',
        '.wordgame join — un autre joueur doit taper ceci pour rejoindre avant le start',
        'Tu as 12 secondes pour répondre : un mot valide, commençant par la bonne lettre, avec au minimum le nombre de lettres demandé',
        'Un mot déjà utilisé dans la partie ne compte pas deux fois',
        '.wordgame top — affiche le classement des meilleurs joueurs (points, victoires, parties jouées)',
        'En multijoueur, le dernier joueur en vie gagne des points bonus au classement'
    ],
